        ...
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          <GlassCard style={{ padding: 36 }}>
            ...
            >
              ...
              <input type="file" accept="image/*" multiple webkitdirectory="boolean" style={{ display: 'none' }} ref={folderInputRef} onChange={(e) => setFiles(Array.from(e.target.files).filter(f => f.type.startsWith('image/')))} />
